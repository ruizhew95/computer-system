...
void eval(char *cmdline) 
{
    ...
    sigset_t mask_child, mask_all, pre_chld, pre_all;
    ...
    Sigprocmask(SIG_BLOCK, &mask_child, &pre_chld);
    if((pid=Fork()) == 0){
